...
export function SectionBlock({ sectionMd, greeting, signature, selectedId, autoSelect, searchQuery }) {
  ...
  return (
    ...
    >
      {/* Заголовок секції + Великий роздільник */}
      {title && (
        ...
        {rawTemplates.map((tplMd, idx) => {
          ...
          return (
            <React.Fragment key={cardId}>
              {/* Короткий роздільник між шаблонами */}
              {idx > 0 && (
